...
import PrembotManager from '../services/auth/PrembotManager.ts';
import { ShopService } from '../services/economy/ShopService.ts';
import { LevelService } from '../services/economy/LevelService.ts';
import { EconomySeasonService } from '../services/economy/EconomySeasonService.ts';
import { MessageHandler } from '../handlers/MessageHandler.ts';
import { WelcomeHandler } from '../handlers/WelcomeHandler.ts';
import { AlertHandler } from '../handlers/AlertHandler.ts';
import memoryManager from '../utils/MemoryManager.ts';
import { jadibotManager } from '../services/external/jadibot.ts';
import * as SafeDownloader from '../services/media/SafeDownloader.ts';
import { globalLogger as logger } from '../utils/Logger.ts';
import { clearPermissionCache } from '../utils/permissions.ts';
...
export class Bot {
    ...
    async initializeWorker() {
        ...
        (global as any).messageHandler = messageHandler;
        const { CLUSTER_CONFIG } = await import('../config/nodes.ts');
        const { WorkerServer } = await import('../services/cluster/WorkerServer.ts');
